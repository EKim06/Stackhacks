...
const ProjectCard = ({ title, date, image, children, className, index = 0 }) => {
  ...
  return (
    <motion.div
      ...
      className="group"
    >
      <div className={`bg-primary/5 backdrop-blur-sm rounded-2xl overflow-hidden border border-primary/10 hover:border-accent/50 transition-all duration-500 ${className || ''}`}>
        {/* Image */}
