...
export const StaggeredMenu = ({
  ...
  React.useEffect(() => {
    ...
    const handleClickOutside = e => {
      if (panelRef.current && !panelRef.current.contains(e.target) &&
          toggleBtnRef.current && !toggleBtnRef.current.contains(e.target)) closeMenu();
    };
  ...
  return (
    <div
      ...
      style={{ display: 'inline-flex', position: 'relative', '--sm-accent': accentColor }}
    ...
    >
      ...
      <style>{`
        .sm-scope .sm-toggle {
          ...
          gap: 0.3rem; background: transparent; border: none; cursor: pointer;
          font-weight: 500; line-height: 1; overflow: visible; z-index: 60;
        }
        .sm-scope .sm-toggle:focus-visible { outline: 2px solid #ffffffaa; outline-offset: 4px; border-radius: 4px; }
        .sm-scope .sm-toggle-textWrap {
          position: relative; margin-right: 0.5em; display: inline-block;
        ...
        .sm-scope .sm-panel-list { list-style: none; margin: 0; padding: 0; display: flex; flex-direction: column; gap: 0.5rem; counter-reset: smItem; }
        .sm-scope .sm-panel-itemWrap { position: relative; overflow: hidden; line-height: 1; }
        .sm-scope .sm-panel-item {
          position: relative; color: #f2f0ef; font-weight: 600; font-size: clamp(3rem, 6vw, 3rem);
          cursor: pointer; line-height: 1; letter-spacing: -2px; text-transform: uppercase;
          display: inline-block; text-decoration: none; padding-right: 1.4em;
          transition: color 0.15s ease;
        }
        .sm-scope .sm-panel-item:hover { color: #feb23a; filter: none; }
        .sm-scope .sm-panel-itemLabel { display: inline-block; transform-origin: 50% 100%; }
        .sm-scope .sm-panel-list[data-numbering] .sm-panel-item::after {
          counter-increment: smItem;
          content: counter(smItem, decimal-leading-zero);
          position: absolute; top: 0.1em; right: 0; font-size: 18px;
          font-weight: 400; color: var(--sm-accent); letter-spacing: 0;
          pointer-events: none; user-select: none; opacity: var(--sm-num-opacity, 0);
        }
        ...
        .sm-scope .sm-socials-link { font-size: 1.2rem; font-weight: 500; color: #f2f0ef; text-decoration: none; display: inline-block; padding: 2px 0; transition: color 0.3s; }
        .sm-scope .sm-socials-link:hover { color: var(--sm-accent); filter: none; }
      `}</style>
    </div>
  );
};
